...
public class LevelManager : MonoBehaviour {
	...
	void Start () {
		sgui = GameObject.Find("GUI").GetComponent<ServerGUI>();
	...
	void Server_LoadMap(){
		//Set the map to load
		StartCoroutine(LoadLevel(curMap.MapLoadName, lastLevelPrefix + 1));
	}
	...
	public void Client_LoadMap(int mIndex, int levelPrefix){
		Debug.Log ("Client -> Load Map");
	}
	...
	void OnDisconnectedFromServer ()
	{
		...
		sgui.menu = ServerGUI.Menu.start;
